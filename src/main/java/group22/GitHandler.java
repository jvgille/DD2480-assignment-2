...
public final class GitHandler{
    /**
    * clone the repository (at a specific branch) and put it in a data-folder
    * where the code can then be compiled and run by the CI server.
    * @param P: the PushPayload that contains the name of the branch that has to be clone
    */
